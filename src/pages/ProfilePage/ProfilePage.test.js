...
it('displays all details of a freelance', async () => {
  ...
  expect(screen.getByTestId('skill-1')).toHaveTextContent('React 2')
  expect(screen.getByTestId('skill-2')).toHaveTextContent('Node.js 2')
  expect(screen.getByTestId('skill-3')).toHaveTextContent('JavaScript 0')
